...
import {getHeaders, getCollectionId} from "../utils/utils.js";
...
export const DateSelector = forwardRef((
    ...
    const updateDatesAvailable = (searchTerm, itemType) => {
        ...
        fetch(`/api/aggregation-info/${getCollectionId()}?${params}`, {
            method: "GET",
            headers: getHeaders()
        }).then(r => {
            if (validateResponse(r, navigate)) {
                ...
                console.log("ERROR: collection data info failed to load, id: ", getCollectionId())
            }
        })
    }
